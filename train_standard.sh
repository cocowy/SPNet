...
python -u train.py --name stereo  --maxdisp 192 --datapath /home/wy/datasets/KITTI --validation kitti --restore_ckpt None --gpus 0 1 --num_steps 500 --batch_size 2 --lr 0.0001 --image_size 288 960 --wdecay 0.00001
